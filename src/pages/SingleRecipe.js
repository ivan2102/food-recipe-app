    ...
    render() {
        ...
        return(
            <div className="container my-5">
                ...
                <div className="col-10 mx-auto col-md-6 my-3">
                 <Link to="/recipes" 
                 className="btn btn-warning mb-5 text-capitalize">back to recipes list
                 </Link>
                 <img src={image_url} className="d-block w-100" style={{ maxHeight: "30rem" }} alt=""/>
                 </div>

               {/* info */}
                <div className="col-10 auto-mx col-md-6 my-3">
                 ...
                 <a href={source_url}
                  target="_blank" rel="noopener noreferrer"
                   className=" btn btn-success text-capitalize mx-2 mt-2">recipe url</a>
